...
?>
                ...
                <tr class="bg-gray-100 text-center border-b text-sm text-gray-600">
                    ...
                    <td class="p-2 border-r"><?php echo $username; ?></td>
                    <td class="p-2 border-r"><?php echo $email; ?></td>
                    <td class="p-2 border-r"><?php echo $admin; ?></td>
                    <td class="border border-slate-300">
                        
                        <a class="border border-green-500 bg-green-500 text-white rounded-md px-4 py-2 m-2 transition duration-500 ease select-none hover:bg-green-600 focus:outline-none focus:shadow-outline" href="edit_user.php?myid=<?=$id?>" type="submit" name="edit_user" value="<?php echo $id;?>">Edit User</button></td>
                        </form>
                    <td class="border border-slate-300">
                        <form method = "POST">
                        <button class="border border-red-500 bg-red-500 text-white rounded-md px-4 py-2 m-2 transition duration-500 ease select-none hover:bg-red-600 focus:outline-none focus:shadow-outline" type="submit" name="user_delete" value="<?php echo $id;?>" >Delete User</button>
                    </td>
                </tr>
<?php
    }
...
if(isset($_POST['user_delete']))
{
    $user_id = $_POST['user_delete'];
        ...
        //     {
                ...
                ?>
                <!-- <form method="POST">
                <input type="text" value="oui" name="valeur"/>
                <input type="text" value="non" name="valeur"/>
                ...
                <span class="font-medium">User/Admin deleted successfully</span>
                </div>
